...
public class MainActivity extends AppCompatActivity
    ...
    private void initViews() {
        ...
        setSupportActionBar(toolbar);// 将toolbar实例传入，这样我们就做到了既使用Toolbar,又让它的外观和功能与ActionBar一致了
        ...
        drawer.setDrawerListener(toggle);//设置侧滑事件
        toggle.syncState();//作用是同步drawer指示器
        ...
        if (id == R.id.nav_home) {
            ...
            drawer.addDrawerListener(new DrawerLayout.DrawerListener() {
                ...
                public void onDrawerClosed(View drawerView) {
                    ...
                    recreate();//recreate()可以使用在日间/夜间模式的切换，可以看到这里调用recreate方法会比正常启动Activity多调用了onSaveInstanceState和onRestoreInstanceState，并且onSaveInstanceState在onCreate方法之前调用。
                }
